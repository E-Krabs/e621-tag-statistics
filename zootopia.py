...
with open('{}JSON/e621-total-2021-10-25-a.json'.format(directory), 'r') as f:
	...
	for key in dic:
		...
		try:
			...
			r4 = 0
		print('{}: {}-{}, {}-{}'.format(key, tag1, r1, tag2, r2, tag3, r3, tag4, r4))
		tr = (key, r1, r2, r3, r4) #tupled result
		lst.append(tr)
		
	print('Plotting Popularity...')
	df = pd.DataFrame(lst, columns = ['Date', '{}'.format(tag1), '{}'.format(tag2), '{}'.format(tag3), '{}'.format(tag4)])
